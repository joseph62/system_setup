...
def install():
    ...
    git.clone_repository_if_not_exists("https://github.com/zsh-users/zsh-syntax-highlighting", "~/.local/opt/zsh-sytax-highlighting")
    
    filesystem.update_file("~/temp/dot-files/resources/aliases", "~/.local/etc/dot-files/.aliases")
    filesystem.update_file("~/temp/dot-files/resources/environment", "~/.local/etc/dot-files/.environment")
